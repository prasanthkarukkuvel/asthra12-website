...
if (isset($_SESSION['intro']))
 ...
 else header('Location:pages/intro/');
...
function menu_tabs()
	{
	$str1 = '<ul class="group" id="example-one" ><li class="current_page_item_one"><a class="c3" href="#">Home</a></li><li><a href="theme.php">Theme</a></li><li><a href="events.php#1">Events</a></li><li><a href="asthra.php">Asthra</a></li><li><a href="pages/event_reg/">Registration</a></li><li><a href="gallery.php">Gallery</a></li><li><a href="contact.php">Contact</a></li><li><a href="pages/Maps/">Site Map</a></li></ul>';
	$str2 = '<ul class="group" id="example-two" ><li class="current_page_item_two"><a class="c3" href="#">Home</a></li><li><a href="theme.php">Theme</a></li><li><a href="events.php#1">Events</a></li><li><a href="asthra.php">Asthra</a></li><li><a href="pages/event_reg/">Registration</a></li><li><a href="gallery.php">Gallery</a></li><li><a href="contact.php">Contact</a></li><li><a href="pages/Maps/">Site Map</a></li></ul>';
...
function ads_details()
	...
	foreach($infos as $i)
		...
		$title = $i->getElementsByTagName("title");
		$t = $title->item(0)->nodeValue;
		echo '<div> <a id="spons" href="#"><img src="images/ads/' . $n . '" width="150" height="150" alt="' . $t . '" /></a> </div>';
		}
	}
